    ...
    <div className="min-h-screen flex flex-col bg-gray-100 relative">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 max-w-sm w-full mx-4 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-700 mb-2 text-sm">
                Great news! Opay and all other banks are now working perfectly.
              </p>
      ...
      <div className="bg-white m-4 p-3 rounded-lg border border-gray-200">
        ...
        <div className="mb-3 border-t pt-3">
          ...
          <div className="flex justify-between items-center">
            <p className="text-lg font-bold">6751136105</p>
            <Button
              variant="default"
              size="sm"
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-1"
              onClick={() => handleCopy("6751136105", "Account Number")}
            >
              <Copy size={14} />
              Copy
            </Button>
        ...
        <div className="mb-3 border-t pt-3">
          ...
          <p className="text-lg font-bold">JOHN LAWRENCE</p>
        </div>
      </div>
